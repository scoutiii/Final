...
MyGame.objects.creep = function(spec) {
    ...
    return {
        ...
        get top() { return that.center.y - (that.size.height / 4); },
        get bottom() { return that.center.y + (that.size.height / 4); },
        get left() { return that.center.x - (that.size.width / 4); },
        get right() { return that.center.x + (that.size.width / 4); },
